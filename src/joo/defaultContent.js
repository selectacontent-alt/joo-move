...
export const DEFAULT_SERVICES = [
  {
    ...
    title_ar: 'نقل الأثاث', title_en: 'Furniture Moving',
    short_ar: 'نقلة منظمة من الباب للباب بفريق مدرّب وعربيات مجهزة.',
    short_en: 'Organized door-to-door moves with trained teams and equipped trucks.',
    body_ar: 'نستلم تفاصيل النقل، نخطط للتحميل والترتيب داخل السيارة، ونوصل كل قطعة للمكان المحدد بأمان ومتابعة مستمرة.',
    body_en: 'We plan loading, secure every item inside the truck and deliver it safely with clear updates throughout the move.',
  ...
  },
  {
    ...
    title_ar: 'التغليف الكامل', title_en: 'Professional Packing',
  ...
  {
    slug: 'assembly', icon: 'Wrench', category: 'assembly', sort_order: 3,
    title_ar: 'فك وتركيب الأثاث', title_en: 'Disassembly & Assembly',
  ...
  {
    slug: 'loading', icon: 'Boxes', category: 'loading', sort_order: 4,
    title_ar: 'الرفع والتنزيل', title_en: 'Loading & Unloading',
    short_ar: 'تنظيم مسار الحركة وحماية المداخل والسلالم أثناء النقل.',
    short_en: 'Planned lifting routes that protect entrances, stairs and furniture.',
    body_ar: 'نراجع المداخل والأدوار والأسانسير قبل التنفيذ ونحدد العدد والأدوات المناسبة للنقلة.',
    body_en: 'We review floors, entrances and lift access before assigning the right crew and equipment.',
    bullets_ar: ['حماية المداخل', 'تنظيم القطع حسب الأولوية', 'معدات رفع مناسبة'],
    bullets_en: ['Entrance protection', 'Priority loading order', 'Proper lifting tools'],
  },
  {
    slug: 'home-office', icon: 'Building2', category: 'office', sort_order: 5,
    title_ar: 'نقل المنازل والمكاتب', title_en: 'Home & Office Moves',
    short_ar: 'خطة مخصصة للمنازل والشركات تقلل وقت التوقف والفوضى.',
    short_en: 'Tailored plans for homes and offices with minimal disruption.',
    body_ar: 'نقسم النقلة لمراحل واضحة ونرتب الأولويات حسب طبيعة المنزل أو ساعات عمل الشركة.',
    body_en: 'We divide the move into clear phases and prioritize around your household or business schedule.',
    bullets_ar: ['جدولة مرنة', 'تقسيم واضح للمراحل', 'تنسيق مسبق مع المسؤول'],
    bullets_en: ['Flexible scheduling', 'Clear move phases', 'Dedicated coordination'],
  },
];
